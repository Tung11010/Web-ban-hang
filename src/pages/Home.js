        ...
        <div className="p-6">
            ...
            <header className="bg-red-700 text-white py-3 flex justify-between px-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button id="cart-btn" className="relative">
                        ...
                        <span
                            id="cart-count"
                            className="absolute top-0 right-0 bg-white text-red-700 text-xs rounded-full px-1"
                        >
                            {cartCount}
                        </span>
                    </button>
            ...
            <nav className="bg-white shadow-md py-3">
                <ul className="flex justify-center space-x-6 font-semibold">
                    ...
                    <li>
                        <a href="/sale" className="hover:text-red-700">
                            SALES PRODUCTS
                        </a>
                    </li>
                    <li>
                        <a href="/news" className="hover:text-red-700">
                            NEWS
                        </a>
                    </li>
                    <li>
                        <a href="/cart" className="hover:text-red-700">
                            SHOPPING CART
                        </a>
                    </li>
                </ul>
